...
import com.example.a7min_worki.databinding.DialogCustomBackConfirmationBinding
import java.util.*
    ...
    private fun setupRestView(){
        ...
        try{
            val soundURI = Uri.parse(
                "android.resource://com.example.a7min_worki/" + R.raw.app_src_main_res_raw_press_start)
